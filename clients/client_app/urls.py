...
from .views import RegistrationView, MyProfileView, LoginView, SignOutView, MainPageView, WorkerProfileView, ServiceProfileView, OrderServiceView, MyVisitsView
